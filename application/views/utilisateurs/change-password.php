            ...
            <div class="modal show" tabindex="-1">
                ...
                <div class="modal-body">  
                    ...
                    <div class="control-group <?= form_error( 'mdp' ) ? 'error' : '' ?>">
                        ...
                        <div class="controls">
                            <input type="password" name="mdp" id="mdp" placeholder="Mot de passe" tabindex="1" 
                                value="<?= set_value( 'mdp', '' ) ?>">
                    ...
                    <div class="control-group <?= form_error( 'mdpc' ) ? 'error' : '' ?>">
                        <label for="mdpc" class="control-label">Confirmation mot de passe</label>
                        <div class="controls">
                            <input type="password" name="mdpc" id="mdpc" placeholder="Confirmation mot de passe" tabindex="2" 
                                value="<?= set_value( 'mdpc', '' ) ?>">
                            <?php if( form_error( 'mdpc' ) ) : ?>
                                <span class="help-block"><?= form_error( 'mdpc' ) ?></span>
                            <?php endif; ?>
                        </div>
                    </div>               
                </div>
